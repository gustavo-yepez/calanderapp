export default [
    ...
    {
      'title': 'DTS ENDS',
      'start': new Date(2020, 12, 6, 0, 0, 0),
      'end': new Date(2020, 12, 13, 0, 0, 0)
    },
    ...
    },
    {
      ...
      'start': new Date(2020, 12, 13, 7, 0, 0),
      'end': new Date(2020, 3, 13, 10, 30, 0)
    },
    {
      'title': 'Birthday Party 3',
      'start': new Date(2020, 12, 13, 7, 0, 0),
      'end': new Date(2020, 12, 13, 10, 30, 0)
    },
    {
      'title': 'Late Night Event',
      'start': new Date(2020, 12, 17, 19, 30, 0),
      'end': new Date(2020, 12, 18, 2, 0, 0)
    },
    {
      'title': 'Multi-day Event',
      'start': new Date(2020, 12, 20, 19, 30, 0),
      'end': new Date(2020, 12, 22, 2, 0, 0)
    }
  ]
